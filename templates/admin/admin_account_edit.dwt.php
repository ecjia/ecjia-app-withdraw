			...
			<fieldset>
				...
				<div class="control-group formSep ">
					...
					<div class="controls chk_radio">
						{if $has_pay_wxpay}
						<input class="uni_style" type="radio" name="payment" value="pay_wxpay" /><span>微信钱包</span>
						{/if}
						{if $has_pay_bank}
						<input class="uni_style" type="radio" name="payment" value="pay_bank" /><span>银行转账</span>
						{/if}
